...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='E:/deep_learn/yolov7-prune-main/runs/server/bean/gkd/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='data/bean.yaml', help='*.data path')
